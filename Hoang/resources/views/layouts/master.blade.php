...
<html lang="en">
	...
	<body>
		<div id="top-bar" class="container">
			...
			<div class="row">
				<div class="span4">
					...
					{{ csrf_field()}}
						<input type="text" name="key" placeholder="Search here..." required="" style="position: relative;height: 20px;">
						<button type="submit" name="btnSearch" style="position:absolute;">Search</button>
		...
		<div class="navbar-inner main-menu" style="position: relative;">	
			<!-- <img style="position:absolute; left:30px" src="themes/images/logo.png" class="site_logo" alt=""> -->
		<a href="/Home" style="position:absolute; left: 30px" class="logo pull-left"><img src="{{ asset('/')}}/themes/images/logo.png" class="site_logo" alt="" /></a>
