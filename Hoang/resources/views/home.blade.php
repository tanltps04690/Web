...
@section('content')
	...
	<section class="header_text">
		<h4 style="color: #FF0000;">There is no bad woman only the woman does not know beauty</h4>
	</section>
										...
										<li class="span3">
											<form action="/ProductDetail" method="post">
													...
													<div class="product-box">
														...
														<p><a href="ProductDetail"><img style="height: 225px" src="{{url('/')}}/upload/{{$item['image']}}" alt="" /></a></p>
									...
									<li class="span3">
										<form action="/ProductDetail" method="post">
											...
											<input type="hidden" name="_token" value="{{ csrf_token() }}">												
												<div class="product-box">
													<span class="sale_tag"></span>
													<p><img style="height: 225px" src="{{url('/')}}/upload/{{$item1['image']}}" alt="" /></p>
									...
									<li class="span3">
										<form action="/ProductDetail" method="post">
											...
											<button type="submit" value="{{$item2['id_product']}}" name="xuan">													
												<div class="product-box">
													<span class="sale_tag"></span>
													<p><a href="ProductDetail"><img style="height: 225px" src="{{url('/')}}/upload/{{$item2['image']}}" alt="" /></a></p>
