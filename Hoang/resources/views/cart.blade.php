                ...
                <input type = "hidden"value ="{{$result = 0}}">
                   ...
                   {{ csrf_field()}}
                            ...
                            @foreach($cart as $value)
                                    <input type = "hidden"value =" {{$result += ($value['price']*$value['quantity'])}}">
                                            <tr id="item_id">
                                                ...
                                                <div class="media">
                                                    <a class="thumbnail pull-left" href="#"> <img class="media-object" src="upload/{{$value['image']}}" style="width: 72px; height: 72px;"> </a>
                    ...
                    <tr>
                        ...
                        @endif
                        {{--  <a id="link" style="color: #FFF; text-decoration: none;" target="_blank" href="https://www.nganluong.vn/button_payment.php?receiver=tanltps04690@fpt.edu.vn&product_name={{$bill_code}}&price={{$result}}&return_url=admin.php?c=home&comments=thanh cong"> Checkout</a> <span class="glyphicon glyphicon-play"></span>  --}}
